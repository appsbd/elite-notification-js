        ...
        const AppsbdUtls =
            {
                ...
                WPCR:function(){
                   ...
                   //  return btoa('<a href="https://elite notification.com" target="_blank">Elite Notification</a>, Copyright ©')+(new Date().getFullYear())+btoa(' <a href="https://appsbd.com" target="_blank">Appsbd</a>. All rights reserved.');
                },
                WPFOOTER:function(){
