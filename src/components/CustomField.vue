...
<!--{{field}}-->
    ...
    <div class="text-start " v-if="field.type == 'T'" >
      <div class="mb-3">
        <input type="text" :label="field.label"  v-model="customProps[field.id]" class="form-control " :id="field.id" :name="field.id" :placeholder="field.placeholder">
<!--        <ErrorMessage :name="field.id" class="apbd-v-error"/>-->
    ...
    <div class="text-start " v-if="field.type == 'N'" >
      <div class="mb-3">
        <Field type="number" :label="field.label" :rules="field.rules" v-model="customProps[field.id]" class="form-control " :id="field.id" :name="field.id" :placeholder="field.help_text"/>
        <ErrorMessage :name="field.id" class="apbd-v-error"/>
      </div>
    </div>
    ...
    <div class="text-start" v-if="field.type == 'U'" >
      <div class="mb-3">
        <Field type="url" :label="field.label" :rules="field.rules" required v-model="customProps[field.id]" class="form-control " :id="field.id" :name="field.id" :placeholder="field.help_text"/>
        <ErrorMessage :name="field.id" class="apbd-v-error"/>
      </div>
    </div>
    ...
    <div class="text-start " v-if="field.type == 'D'" >
      <div class="mb-3">
        <Field type="date" :label="field.label" :rules="field.rules" v-model="customProps[field.id]" class="form-control " :id="field.id" :name="field.id" :placeholder="field.help_text"/>
        <ErrorMessage :name="field.id" class="apbd-v-error"/>
      </div>
    </div>
    ...
    <div class="text-start" v-if="field.type=='R'">
      <div class="d-flex mb-2 justify-content-between align-items-center ">
        <div class="text-start">
          <span :class="field.rules=='required'?'ht_tks_required_fld':''">{{field.label}}</span>
        </div>
      </div>
    ...
    <div v-if="field.type == 'W'" >
      <div class="mb-3">
        <select class="form-select " v-model="customProps[field.id]">
    ...
    <div class=" text-start " v-if="field.type == 'E'">
      <div class="mb-3">
        <Field as="textarea" class="form-control" :placeholder="field.help_text" type="text" :label="field.label" :name="field.id" :id='field.id' v-model="customProps[field.id]" :rules="field.rules"   />
        <ErrorMessage :name="field.id"  class="apbd-v-error"/>
      </div>
    </div>
