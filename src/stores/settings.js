...
export const useSettingsStore = defineStore('settings',{
    ...
    getters:{
        ...
        pos_mode(){
            if (this.appOptions?.basic_settings?.pos_mode) {
                return this.appOptions.basic_settings.pos_mode;
            }
            return '';
        },
        login_ph(){
    ...
    actions: {
        ...
        updatePushSettings: async function (options) {
            return (await AxiosHelper.post(apssbd_admin_url.get_module_url(module_id, "push-settings"), options,true)
                .then(response => {
                    this.appOptions = response.data?.data;
                    return response.data;
                })
        ...
        updateStockSettings: async function (options) {
            return (await AxiosHelper.post(apssbd_admin_url.get_module_url(module_id, "stock-settings"), options,true)
                .then(response => {
                    this.appOptions = response.data?.data;
                    return response.data;
                })
